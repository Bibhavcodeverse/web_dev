        ...
        <div class="row">
          <div class="col-md-12">
            <div class="text-content">
              <h4>Communition / Consultant Jobs</h4>

              <h2>Communication Assistant - Aasmaan Ki Udaan NGO</h2>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-9 col-sm-8">
              <p class="lead">
                   <i class="fa fa-map-marker"></i> Botanical Garden, New Delhi &nbsp;&nbsp;
                   <i class="fa fa-calendar"></i> 10-02-2024 &nbsp;&nbsp;
              ...
              <p>We are seeking a dynamic and motivated Real Estate Communication Assistant to join our team at Aasmaan Ki Udaan NGO. The ideal candidate will be passionate about real estate, possess excellent communication skills, and thrive in a fast-paced, competitive environment. <br><br>
                Responsibilities:<br>
          ...
          <div class="col-md-3 col-sm-4">
            ...
            <div>
              <img src="assets/images/sales-1.jpeg" alt="" class="img-fluid wc-image">
            </div>
