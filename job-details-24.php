        ...
        <div class="row">
          <div class="col-md-12">
            <div class="text-content">
              <h4>Site / Engineering Jobs</h4>

              <h2>Civil Site Engineer - Truearth Developers</h2>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-9 col-sm-8">
              <p class="lead">
                   <i class="fa fa-map-marker"></i> Vikhroli East, Mumbai/Bombay &nbsp;&nbsp;
                   <i class="fa fa-calendar"></i> 28-09-2023 &nbsp;&nbsp;
              ...
              <p>The candidate should have completed Post Graduate degree and people who have 5 to 31 years are eligible to apply for this job. You can apply for more jobs in Mumbai to get hired quickly. <br><br>
                Responsibilities:<br>
                Overseeing construction activities and ensuring compliance with engineering specifications and safety standards.
                Collaborating with architects, contractors, and other stakeholders to resolve technical issues and ensure project success.
                Managing and coordinating subcontractors and suppliers to ensure timely delivery of materials and services.
              ...
              <p>Requirements:<br>
                ...
                Strong understanding of construction methods, materials, and techniques.</p> 
          ...
          <div class="col-md-3 col-sm-4">
            ...
            <div>
              <img src="assets/images/product-18.jpeg" alt="" class="img-fluid wc-image">
            </div>
        ...
        <div class="row">
          <div class="col-md-9">
            <div class="section-heading">
              <h2>About Truearth Developers</h2>
            </div>
            ...
            <p>Truearth Developers is aggressively hiring for the job profile of Civil Site Engineer at Mumbai in Kannamwar Nagar Ii locality. Kindly go through the FAQs below to get all answers related to the given job.</p>
            <br>
