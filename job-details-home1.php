        ...
        <div class="row">
          <div class="col-md-12">
            <div class="text-content">
              <h4>Sales / Marketing Jobs</h4>

              <h2>Sales Customer Executive - PIC Limited</h2>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-9 col-sm-8">
              <p class="lead">
                   <i class="fa fa-map-marker"></i> Connaught-Palace,New Delhi &nbsp;&nbsp;
              ...
              <p>We are seeking a dynamic and motivated Real Estate Sales Representative to join our team at PIC LImited. The ideal candidate will be passionate about real estate, possess excellent communication skills, and thrive in a fast-paced, competitive environment. <br><br>
                Responsibilities:<br>
          ...
          <div class="col-md-3 col-sm-4">
            ...
            <div>
              <img src="assets/images/job-1.jpg" alt="" class="img-fluid wc-image">
            </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-9">
            ...
            <p>PIC Limited is a leading real estate company dedicated to providing exceptional service to clients seeking to buy, sell, or rent properties. With a focus on integrity, professionalism, and innovation, we strive to exceed client expectations and build long-lasting relationships within the community.</p>
            <br>
