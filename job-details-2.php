        ...
        <div class="row">
          <div class="col-md-12">
            <div class="text-content">
              <h4>Language / Developer Jobs</h4>

              <h2>Python Developer - Odudumo Solutions (Opc) Private Limited</h2>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-9 col-sm-8">
              <p class="lead">
                   <i class="fa fa-map-marker"></i> Greater Noida &nbsp;&nbsp;
              ...
              <p>We are seeking a dynamic and motivated Python Developer to join our team at Opc Private Limited. The ideal candidate will be passionate about real estate, possess excellent communication skills, and thrive in a fast-paced, competitive environment. <br><br>
                Responsibilities:<br>
                Proficient in Python programming language with a strong understanding of object-oriented programming principles.
                Experience working with web frameworks such as Django or Flask.
              ...
              <p>Requirements:<br>
                The candidate should have completed Graduate degree and people who have 0 to 31 years are eligible to apply for this job
                Excellent communication and negotiation skills.
                Ability to work independently as well as part of a team in a fast-paced environment.
                Ability to work independently and manage time effectively.
                Commitment to continuous learning and staying updated with industry trends in software development.</p> 
          ...
          <div class="col-md-3 col-sm-4">
            ...
            <div>
              <img src="assets/images/sales-2.jpeg" alt="" class="img-fluid wc-image">
            </div>
        ...
        <div class="row">
          <div class="col-md-9">
            <div class="section-heading">
              <h2>About Odudumo Solutions (Opc) Private Limited</h2>
            </div>
            ...
            <p> Odudumo Solutions (Opc) Private Limited is aggressively hiring for the job profile of Python Developer at Delhi-NCR in Delhi-NCR locality. Kindly go through the FAQs below to get all answers related to the given job.</p>
            <br>
